...
export const SHELLS: Shell[] = [
  {
    ...
    tagline: "A versatile all-rounder built around the Biosampler hook, damage mitigation, and crowd control — Mortal Shell 2's easiest Shell to learn.",
  ...
  },
  {
    ...
    name: "Tiel",
    role: "Assassin / Speed",
    tagline: "A shadow assassin who rewards perfect dodges with bonus offensive windows — fast, aggressive, and lethal in hit-and-run play.",
  ...
  },
  {
    ...
    name: "Gragu",
    role: "Berserker / Fire",
    tagline: "A blood-fueled berserker who trades health for heavy fire damage and AoE — one of the safest boss-killers in the roster.",
  ...
  },
  {
    ...
    name: "Eredrim",
    role: "Tank / Heavy",
    tagline: "A heavy tank who trades speed for raw durability and punishing melee — soaks damage and answers with massive deliberate strikes.",
  ...
  },
  {
    ...
    tagline: "A time-bending monk who stops time for free attack windows, regenerates health through strikes, and detonates Chaos stacks.",
  ...
  },
  {
    ...
    tagline: "A cursed thorn-tank who converts damage taken into grey health and reflects melee hits — the highest skill ceiling on the roster.",
  ...
  },
  {
    ...
    name: "Lazlo",
    role: "Tank / Heat",
    tagline: "A heavy-armor tank who soaks big hits, builds Heat into an overheat spike, and vents it as a flame shockwave.",
  ...
  },
  {
    ...
    tagline: "A summoner who fights through her Faithful Doubles — clones that attack and CC on her behalf — with a built-in second chance.",
