...
export const WEAPONS: Weapon[] = [
  ...
  },
  {
    ...
    primaryStats:
      "One of the highest raw damage two-handers in the game. Heavy swing applies a short Holy damage-over-time tick to anything hit by the blade portion.",
    specialAbility:
    ...
    notes:
      "Shockwave has no friendly fire damage. There is also a reported animation cancel where a Shell swap during the charge window lets you fire the shockwave instantly, which may be tuned down in a future patch.",
  },
  {
  ...
  },
  {
    ...
    primaryStats:
      "Highest Strength scaling in the game. Swing speed is slow but manageable for an ultra greatsword due to the weight-saving enchantment. Every hit knocks back non-boss enemies.",
    specialAbility:
    ...
    notes:
      "Weight enchantment also reduces the stamina cost of rolling while the weapon is two-handed, which was not the behavior in pre-release preview footage. This may be patched out, so do not build around the reduced roll cost just yet.",
  },
  {
    id: "martyrs-blade",
    name: "Martyr's Blade",
    ...
    obtain:
      "Chest in the room after the Magdalena fight, at the end of the Sunken Village campaign. You cannot miss it; the door locks behind you once the boss ends and the chest is the only thing in the room.",
    playstyle:
    ...
    notes:
      "Glow timer for the low-health bonus persists for 10 seconds even after you recover Shell health through a shrine. This extra carryover lets you chain the bonus from one fight into another if you grab a shrine on the way. This may be patched out in a future update.",
  },
  {
    id: "smoldering-mace",
    ...
    primaryStats:
      "Longest reach for a single-handed blunt weapon in the game. Heavy swing burns each target caught in the arc for 3 stacked ticks of fire damage.",
    specialAbility:
